...
export default function Footer() {
  return (
    <footer className="bg-[#151c29] border-t border-[#232b3d] text-gray-300 pt-16 pb-8 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between gap-12 md:gap-0">
        {/* Brand & tagline */}
        <div className="flex flex-col gap-4 md:w-1/4">
          <Link href="/" className="text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-fuchsia-500 to-orange-400">
         ERRTEKNALOZY Solutions
          </Link>
          <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
            Building world-class digital solutions for ambitious teams, with a focus on quality, security, and scale.
          </p>
        ...
        <div className="flex-1 grid grid-cols-2 sm:grid-cols-4 gap-8">
          {NAV_LINKS.map((col) => (
            <div key={col.heading}>
              <h4 className="text-lg font-semibold text-white mb-4">{col.heading}</h4>
      ...
      {/* Bottom - legal */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between mt-14 border-t border-[#232b3d] pt-6 gap-2 text-sm text-gray-500">
        <div>
          &copy; {new Date().getFullYear()} Errteknalozy Solutions. All rights reserved.
        </div>
