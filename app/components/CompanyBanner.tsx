  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-gray-950 text-gray-900 dark:text-white py-20 px-6 sm:px-12 lg:px-24 rounded-4xl shadow-xl border border-gray-200 dark:border-gray-800">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <div className="mt-10">
          <button className="bg-gradient-to-r from-fuchsia-600 to-cyan-500 text-white px-8 py-3 rounded-xl shadow-lg text-lg font-semibold hover:scale-105 hover:opacity-90 transition-all duration-300 ease-out focus:outline-none focus:ring-4 focus:ring-fuchsia-300 dark:focus:ring-cyan-700">
            Schedule a Call
          </button>
        </div>
      </div>
