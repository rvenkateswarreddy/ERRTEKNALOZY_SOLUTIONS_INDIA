...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    companyLogo: "https://seeklogo.com/images/S/scale-ai-logo-8D0DF9BBA1-seeklogo.com.png",
    quote:
...
export default function Testimonials() {
  ...
  return (
    <section className="relative py-24 px-4 sm:px-8 bg-gradient-to-b from-[#1a2236] to-[#202a44]">
      <div className="max-w-5xl mx-auto text-center mb-14">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-500 via-blue-500 to-cyan-400">
        ...
        <div className="flex-1 min-h-[280px]">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-[#222b44]/70 rounded-2xl shadow-2xl px-8 py-10 flex flex-col justify-center items-center"
              aria-live="polite"
            >
              {/* Star Rating */}
              ...
              {/* Text */}
              <blockquote className="text-lg md:text-2xl text-gray-100 font-semibold mb-6 text-center">
                “{TESTIMONIALS[active].quote}”
              </blockquote>
              {/* Profile */}
              <div className="flex flex-col items-center gap-0">
                <span className="font-bold text-cyan-300 text-lg">{TESTIMONIALS[active].name}</span>
                <span className="text-gray-400 text-sm">{TESTIMONIALS[active].title}</span>
              </div>
            </motion.div>
          </AnimatePresence>
        </div>
