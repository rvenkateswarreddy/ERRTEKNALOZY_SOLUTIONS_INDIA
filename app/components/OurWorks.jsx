...
import { FaReact, FaNodeJs, FaPython, FaJava, FaAws, FaDatabase, FaAndroid, FaApple, FaAngular, FaPhp, FaHtml5, FaCss3Alt } from "react-icons/fa";
import { SiNextdotjs, SiMongodb, SiTailwindcss, SiFirebase, SiDjango, SiFlutter, SiLaravel, SiMysql, SiKubernetes, SiDocker } from "react-icons/si";
    ...
    <div>
      <div className="text-center mx-auto max-w-2xl mb-10">
        <p className="text-gray-300 text-base">
          Our team provides end-to-end support, project delivery, troubleshooting, and optimization on a wide range of leading technologies and platforms. Whether you need full-stack development, mobile apps, cloud, or DevOps—we've got your stack covered.
        </p>
      </div>
      <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-8">
        {techSupports.map((tech, idx) => (
          ...
          >
            ...
            <div className="text-lg font-semibold text-cyan-300 mb-1">{tech.name}</div>
            <div className="text-cyan-200 text-sm mb-2">{tech.short}</div>
            <div className="text-gray-400 text-xs">{tech.desc.slice(0, 60)}...</div>
            <button
              className="mt-5 py-2 px-5 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded-lg transition"
        ...
        <div className="fixed inset-0 z-40 bg-black/80 flex items-center justify-center px-3">
          <div className="bg-gradient-to-br from-[#181b29] via-[#0a0a0a] to-[#191c24] border-2 border-cyan-700 rounded-2xl shadow-2xl p-8 max-w-lg w-full relative animate-fade-in">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-xl font-bold text-cyan-300">{techSupports[modal].name}</span>
            </div>
            <div className="mb-2 text-cyan-200 text-base font-semibold">{techSupports[modal].short}</div>
            <div className="mb-5 text-gray-300">{techSupports[modal].desc}</div>
            <div className="mb-5">
              <div className="font-semibold text-cyan-400 mb-2">Key Areas We Support:</div>
